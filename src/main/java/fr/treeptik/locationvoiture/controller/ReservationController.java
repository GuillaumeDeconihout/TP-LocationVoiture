...
public class ReservationController {
	...
	public ModelAndView initForm(Reservation reservation) throws ServiceException {
		List<Client> listClients = clientService.findAllConcatSort();
		List<Voiture> listVoitures = voitureService.findAllConcatSort();
		
		ModelAndView modelAndView = new ModelAndView("Reservation/saisie-reservation",
	...
	public ModelAndView SaveReservation(@Valid Reservation reservation, BindingResult errors) throws ServiceException {
	...
	public ModelAndView modifierReservation(@RequestParam("id") Integer id)
		...
		ModelAndView modelAndView = new ModelAndView("Reservation/modification-reservation",
				"reservation", reservation);
	...
	public ModelAndView updateReservation(@Valid Reservation reservation, BindingResult errors) throws ServiceException {
	...
	public ModelAndView listerReservation() throws ServiceException {
		...
		ModelAndView modelAndView = new ModelAndView("Reservation/list-reservation",
